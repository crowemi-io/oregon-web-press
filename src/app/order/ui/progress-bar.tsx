const steps = [
    { id: 'Step 1', name: 'Project details', href: '#', status: 'complete' },
    { id: 'Step 2', name: 'Printing', href: '#', status: 'upcoming' },
    { id: 'Step 3', name: 'Finishing', href: '#', status: 'upcoming' },
    { id: 'Step 4', name: 'Delivery', href: '#', status: 'upcoming' },
  ]

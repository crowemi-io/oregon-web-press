...
import Modal, {IModalProps, ModalType} from "@/ui/modal";
...
export default function Footer() {
  ...
  async function handler(formData: any) {
    ...
    if (ret.success) {
      var message = ret.message ? ret.message : 'You\'ve been subscribed';
      var title = 'Success';
      var type = ModalType.Success;
    } else {
      var message = ret.message ? ret.message : 'Something went wrong';
